...
export const Footer = () => {
  return (
    <div className='rounded-div mt-2 pt-5 pb-10 flex flex-col items-center gap-y-10 md:flex-row md:justify-between antialiased'>
      <div className='flex gap-x-7 md:ml-10 text-md font-normal'>
        <section>
            <h3 className='text-2xl mb-4'><b>SUPPORT</b></h3>
        ...
        <section>
            <h3 className='text-2xl mb-4'><b>INFO</b></h3>
            <div className='flex flex-col gap-y-2'>
            <div>ABOUT US</div>
            <div>CAREERS</div>
       ...
       <div className='flex flex-col w-full md:w-fit md:text-start text-center md:mr-10 text-2xl'>
          <b>Sign Up For Crypto News</b>
          
          <div className='mt-5 flex flex-col md:flex-row gap-y-2 md:gap-x-2'>
            <input type="email" 
            placeholder='Enter Your Email'
            className='h-10 rounded-2xl px-4 focus:outline-none'
            />
