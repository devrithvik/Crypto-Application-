    ...
    <div className='mt-10 flex justify-center'> 
       <form 
          ...
          className='flex flex-col text-white box-border w-[70%] bg-black/80 px-5 py-3 sm:px-8 sm:py-16 md:w-[450px] md:px-10 md:py-[10vh]  gap-10'>
            ...
            <input 
            onChange={(e) => setEmail(mail => e.target.value)} 
            ...
            <p className='text-white/80'>Already signed up to Crypto <Link to='/signin' className='text-blue-500 hover:text-blue-800'>SignIn</Link> </p>
